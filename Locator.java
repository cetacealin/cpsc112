//Finally we build the main program Locator with a main method. 
//As the program starts, it loads the data; then it asks for an input address, 
//finds its geographical location, and searches for the closet store.
